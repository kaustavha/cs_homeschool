...
// 		return false;
// 	}
// 	// console.log(blk.length, includeCanada, includeusa, blk.match(/san francisco/gi))
// 	if (blk.match(/remote/gi))
// 		return blk;
// 	if (includeCanada)
...
// function deprecated_parseEmailFromBlock(t, iteration) {
...
// function deprecated_parseBuzzwords(txt) {
// 	let keywords = [
